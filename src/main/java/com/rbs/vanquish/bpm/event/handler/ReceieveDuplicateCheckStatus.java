...
-------------------------------------------------------------------------------------------------------- **/
public class ReceieveDuplicateCheckStatus implements MessageExecutor{
	
	private static final Logger LOGGER = LoggerFactory.getLogger(ReceieveDuplicateCheckStatus.class);
	...
	public void executeMessage(MessageExecutionContext aMessageExecutionContext, Message aMessage)
	{
		try
		{
			...
			logMessage("\n\n IAM GOING TO PROCESS MESSAGE FROM  ReceieveDuplicateCheckStatus \n\n");
		}
